...
description: Generates high-quality Antigravity agent skill directories from user requirements. Use when the user asks to "create a skill", "build a skill", "make a new skill", or wants to scaffold a new .agent/skills/ module.
---
...
- User asks to "create a skill", "build a skill", or "make a new skill"
- User wants to scaffold a new `.agent/skills/` module
- User describes a repeatable workflow they want to automate as a skill
- User says "based on my skill creator instructions, build me a skill for..."
...
2. The agent will generate the full folder structure, `SKILL.md`, and any supporting files.
3. Place the generated folder inside your `.agent/skills/` directory or your AntiGravity Skills folder.
