---
name: blast-master-prompt
description: The B.L.A.S.T. (Blueprint, Link, Architect, Stylize, Trigger) master system prompt for deterministic, self-healing automation projects. Use when starting a new project, building automations, or when the user says "use BLAST", "new project", or "master prompt".
---
...
- Starting any new project or automation
- User says "use BLAST", "new project", or "master prompt"
- Building multi-phase workflows with external integrations
- Any project requiring deterministic, self-healing automation
